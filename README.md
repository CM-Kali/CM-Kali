...
## 📱 Featured Projects
*(These are just a few of my many Flutter and full-stack projects.)*

### 🧮 CM CALCO  
A beautifully designed **scientific calculator app** built with Flutter.  
Includes logarithmic, nCr, and trigonometric functions with animations, keyboard input, and a clean white UI.

---

### 🧠 CM QUIZZO  
An engaging **quiz app** featuring 3 difficulty levels, animated transitions, and detailed result analytics.  
Uses Firebase for data and provides real-time result tracking and performance graphs.

---

### 🎨 CM PHOTO FRAME APP  
A creative photo editor where users can apply **flag-based frames** to their images and save them locally.  
Integrated with **Google AdMob** for both **banner** and **interstitial ads**, demonstrating monetization setup within Flutter apps.

---

## 🔒 Private Projects

### 🚗 CBER — Ride Hailing Platform *(Private)*  
A large-scale **ride-hailing application** inspired by Uber and Yango.  
